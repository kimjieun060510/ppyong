...
5. 시작 화면의 **비회원으로 시작하기**를 누르면 홈으로 들어가고, 홈의 **시작**으로 게임이 열려야 합니다. **로그인하기**는 선택이며, 누르면 시스템 Apple 시트가 열려야 합니다.
...
4. 심사에 대비해, 시작 화면에서 **비회원으로 시작하기** 후 홈의 **시작**이 되는지를 확인합니다. Sign in with Apple은 선택이며 심사 기기의 Apple ID로 로그인하면 됩니다. 서버 로그인이 없습니다.
